...
<div class="container">
     <div class="copyright-txt"><?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','banquet-hall');?> <a href="<?php echo esc_url('https://www.sktthemes.org/product-category/wedding/');?>" target="_blank">
        <?php esc_html_e('SKT Wedding Themes','banquet-hall'); ?>
        </a></div>
     <div class="clear"></div>
</div>           
</div>
